...
<div id="career">
    <div class="container">
      <div class="row">
        <div class="col-sm-12">
          <h3 class="head">submit resume</h3>
            ...
            <div class="container-fluid">
                <div class="row">
                  <div class="grid">
                    ...
                    <div class="col-xs-6">
                      <div class="input_wrapper">
                        <label for="">persent company name</label>
                        <input class="input" type="text" name="" value="">
                    ...
                    <div class="col-xs-6">
                      <div class="input_wrapper">
                        <label for="">current designation  <span>*</span></label>
                        <input class="input" type="text" name="" value="">
                    ...
                    <div class="col-xs-6">
                      <div class="input_wrapper">
                        <label for="">upload resume<span>*(.txt and .doc file only- max 100kb)</span></label>
